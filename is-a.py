...
strPath = "C:\\Users\\simin\\Desktop\\IEEE-ICDM.txt"
f = open(strPath)
strText = f.read()
abstract = []
                ...
                try:
                    if keyphrase[k] in abstract[i][conjunction_ind-30:conjunction_ind]: ## search previous 30 characters for the keyphrases
                       ...
                       for m in range(len(keyphrase)):
                            if keyphrase[m] in abstract[i][conjunction_ind+offset:conjunction_ind+offset+30]: ## search the next 30 characters for keyphrases plus offset
                                #print('found leaf') 
